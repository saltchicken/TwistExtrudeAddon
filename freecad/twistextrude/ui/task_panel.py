...
class TwistTaskPanel(BaseTaskPanel):
    ...
    def get_config_from_ui(self) -> TwistConfig:
        return TwistConfig(total_height=self.form.height_spin.value(),
    ...
    def generate_final(self):
        config = self.get_config_from_ui()
        workflow.inject_twist_into_document(self.profile_obj, self.path_obj,
                                            config)
